...
3. Nhấp tiếp vào nút **Create item**.
4. Trên giao diện nhập, bấm chọn nút chuyển đổi sang chế độ **JSON view**.
5. Sao chép và dán đoạn mã dữ liệu JSON dưới đây vào khung soạn thảo:
